...
#+BEGIN_SRC lisp :var arg="/tmp/proto-0.png" :post namestring(path=*this*) :results file drawer :exports both
...
#+BEGIN_SRC lisp :var arg="/tmp/proto-1.png" :post namestring(path=*this*) :results file drawer :exports both
